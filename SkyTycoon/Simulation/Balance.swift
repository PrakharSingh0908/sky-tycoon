...
enum Balance {
    ...
    static let eventDeck: [EventCard] = [
        ...
        EventCard(id: "regionalSubsidy", category: .opportunity,
            title: "Regional Route Subsidy",
            body: "The government is offering a subsidy to keep a smaller city connected. Take it, or focus elsewhere.",
            baseWeight: 0.6, isNegative: false, minTotalWeek: 12,
            options: [
                EventOption(label: "Take the subsidy · +$50K",
                            effects: [.cash(50_000)]),
                EventOption(label: "Focus elsewhere",
                            effects: []),
            ],
            isEligible: { !$0.routes.isEmpty }),
